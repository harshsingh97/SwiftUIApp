...
//  SwiftUIApp
//
//  Created by Harsh Singh on 5/22/20.
    ...
    var body: some View {
        VStack(spacing: 20) {
            Rectangle()
                ...
                .cornerRadius(3)
                .opacity(0.1)
            Text("This certificte is to prove that Harsh Singh has achieved the UI Design course with the approval from a Design+Code instructor")
                .multilineTextAlignment(.center)
                .font(.subheadline)
                .lineSpacing(4)
            
            HStack(spacing: 20.0) {
                RingView(show: $show, color1: #colorLiteral(red: 0.1215686277, green: 0.01176470611, blue: 0.4235294163, alpha: 1), color2: #colorLiteral(red: 0.8549019694, green: 0.250980407, blue: 0.4784313738, alpha: 1), width: 88, height: 88, percent: 78)
